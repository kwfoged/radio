...
# ------------- Plotting On Tab 1-------------------------
	def plot(self):
		print "noget"
		print self.data1_arr
		data = []
		data.append(self.data1_arr) # Dummy
		data.append(self.data1_arr)	# Dummy
		data.append(self.data1_arr)
		#data.append(self.data1_arr)
		#data.append(self.data1_arr)
		#data.append(self.data1_arr)
		#data.append(self.data1_arr)
		...
		#data.append([random.random() for i in range(10)])
		data.append([random.random() for i in range(50)])
		data.append([random.random() for i in range(50)])
		data.append([random.random() for i in range(50)])
		data.append([random.random() for i in range(50)])
		data.append([random.random() for i in range(50)])
...
## ------------- Plotting On Tab 2 -------------------------
	...
	def tick(self):
		if (arduinoData.inWaiting()==0): #Wait here until there is data
			...
			if(self.time_var > 49):                            #If you have 50 or more points, delete the first one from the array
			...
			self.data1_arr.append(float(dataArray[0]))                     #Build our tempF array by appending temp readings
			data2_arr.append(dataArray[1])                     #Building our pressure array by appending P readings
			data3_arr.append(dataArray[2])
			data4_arr.append(dataArray[3])
			time_vec.append(self.time_var)
			#print self.data1_arr
